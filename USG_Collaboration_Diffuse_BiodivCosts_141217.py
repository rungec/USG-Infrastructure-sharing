...
#inpDir ="C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\tif\\"+"*.tif"
#outDir2 = "C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\Species_Area\\"
#shpDir ="C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\shp\\"

inpDir2="C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\shp_Albers\\"+"*.shp"
inpDir3="C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\shp_Albers\\"
scenDir = "C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Infrastructure shps\\Diffuse_impacts_v2\\"
outDir ="C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\scen_shp_diffuse\\"
outDir3 = "C:\\Claire\\GPEM_Postdoc\\1_USG_Collaboration\\Data\\Species\\thresholdmaps\\191sp\\Species_Scenario_Area_diffuse\\"
...
#####
##Part 2
scenlist=glob.glob(str(scenDir+"*.shp"))
...
for currFile in filelist2:
        ...
        temp1 = str(currFile.split("\\")[9])
        temp2 = str(temp1.split(".")[0])
        temp3 = str(temp2.split("_")[0]) + "_" + str(temp2.split("_")[1])

        #Calculate range size of species
        # print "Starting calculate species range"
        # fullArea = outDir2 + temp2 + "_Area.shp"
        ...
        for currScen in scenlist:
                temp4=str(currScen.split("\\")[7])
                currScenName= str(temp4.split(".")[0])
                currScenShp = currScen
                ...
                outSpArea = outDir3 + currScenName + "_" + temp3 + "_spArea.shp"

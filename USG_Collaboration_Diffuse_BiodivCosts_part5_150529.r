...
inpDir1<- "Z:/ayesha/USG_Collaboration/Data/Species/Species spreadsheets/183sp/Species_Areas_Percent_"
inpDir2<- "Z:/ayesha/USG_Collaboration/Data/Species/Species spreadsheets/183sp/Species_Areas_ImpactasPercent_"
...
numspecies <-183
outDir <- "Z:/ayesha/USG_Collaboration/Analysis/tables/"
AreaVecPath <- "Z:/ayesha/USG_Collaboration/Data/Species/Species spreadsheets/183sp/Species_Area_totals.csv"
...
for (i in 0:3){
	...
	outPath <- paste0(outDir, Scens[i+1], "_diffuse_biodiversity_total_byspecies_areas.csv")
